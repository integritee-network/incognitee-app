<template>
  <div v-if="show" class="p-3">
    ...
    <WarningBanner
      :isMobile="isMobile"
      textMobile="Incognitee for AssetHub Polkadot is undergoing planned maintenance since Oct 3rd. 9:00 UTC and it takes longer than planned. We will keep you informed about the progress here."
      textDesktop="Incognitee for AssetHub Polkadot is undergoing planned maintenance since Oct 3rd. 9:00 UTC and it takes longer than planned. We will keep you informed about the progress here."
    />
    <!-- div v-else>
      <CampaignBanner
